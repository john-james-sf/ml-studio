...
class LinearRegressionTests:
    ...
    def test_validation(self, get_ames_data, get_optimizer):
    ...
    def test_prepare_data_w_fit_intercept_n_validation(self, get_ames_data, get_optimizer):
    ...
    def test_prepare_data_wo_fit_intercept_w_validation(self, get_ames_data, get_optimizer):
        optimizer = get_optimizer
        X, y = get_ames_data
    ...
    def test_prepare_data_w_fit_intercept_wo_validation(self, get_ames_data, get_optimizer):
        optimizer = get_optimizer
        X, y = get_ames_data        
    ...
    def test_prepare_data_wo_fit_intercept_wo_validation(self, get_ames_data, get_optimizer):
        optimizer = get_optimizer
        X, y = get_ames_data        
    ...
    def test_init_weights(self, get_ames_data, get_optimizer):
        optimizer = get_optimizer
        X, y = get_ames_data
    ...
    def test_fit_linear_regression_w_validation(self, get_ames_data, get_optimizer):        
        # Run model
        optimizer = get_optimizer
        X, y = get_ames_data
        lr = LinearRegression(optimizer=optimizer, epochs=5)
    ...
    def test_fit_linear_regression_wo_validation(self, get_ames_data, get_optimizer):        
        # Run model
        optimizer = get_optimizer
        X, y = get_ames_data
    ...
    def test_fit_linear_regression_wo_fit_intercept_wo_validation(self, get_ames_data, get_optimizer):        
        # Run model
        optimizer = get_optimizer
        X, y = get_ames_data
        lr = LinearRegression(optimizer=optimizer, monitor='train_cost', val_size=0, epochs=5,
    ...
    def test_fit_linear_regression_monitor_train_cost(self, get_ames_data, get_optimizer):        
        # Run model
        optimizer = get_optimizer
        X, y = get_ames_data
    ...
    def test_fit_linear_regression_monitor_train_score(self, get_ames_data, get_optimizer):        
        # Run model
        optimizer = get_optimizer
        X, y = get_ames_data
    ...
    def test_fit_linear_regression_monitor_val_cost(self, get_ames_data, get_optimizer):        
        # Run model
        optimizer = get_optimizer
        X, y = get_ames_data
    ...
    def test_fit_linear_regression_monitor_val_score(self, get_ames_data, get_optimizer):        
        # Run model
        optimizer = get_optimizer
        X, y = get_ames_data
    ...
    def test_predict_linear_regression(self, get_ames_data, get_optimizer):
        optimizer = get_optimizer
        X, y = get_ames_data
        lr = LinearRegression(optimizer=optimizer, epochs=5)
        lr.fit(X, y)
    ...
    def test_score_linear_regression(self, get_ames_data, get_optimizer):
        optimizer = get_optimizer
        X, y = get_ames_data
        lr = LinearRegression(optimizer=optimizer, epochs=5)
        lr.fit(X, y)
