...
class SGDRegressionTests:
    ...
    def test_sgd_validation(self, get_ames_data):
    ...
    def test_sgd_prepare_data_w_fit_intercept_n_validation(self, get_ames_data):
    ...
    def test_sgd_prepare_data_wo_fit_intercept_w_validation(self, get_ames_data):
        X, y = get_ames_data
    ...
    def test_sgd_prepare_data_w_fit_intercept_wo_validation(self, get_ames_data):
        X, y = get_ames_data        
    ...
    def test_sgd_prepare_data_wo_fit_intercept_wo_validation(self, get_ames_data):
        X, y = get_ames_data        
    ...
    def test_sgd_init_weights(self, get_ames_data):
        X, y = get_ames_data
    ...
    def test_sgd_fit_linear_regression_w_validation(self, get_ames_data):        
        # Run model
        X, y = get_ames_data
        lr = LinearRegression(epochs=5)
        lr.fit(X, y)
    ...
    @mark.fit
    @mark.fit_linear_regression
    def test_sgd_fit_linear_regression_wo_validation(self, get_ames_data):        
        # Run model
        X, y = get_ames_data
    ...
    @mark.fit
    @mark.fit_linear_regression
    def test_sgd_fit_linear_regression_wo_fit_intercept_wo_validation(self, get_ames_data):        
        # Run model
        X, y = get_ames_data
        lr = LinearRegression(monitor='train_cost', val_size=0, epochs=5,
                              fit_intercept=False)
    ...
    @mark.fit
    @mark.fit_linear_regression
    def test_sgd_fit_linear_regression_monitor_train_cost(self, get_ames_data):        
        # Run model
        X, y = get_ames_data
    ...
    @mark.fit
    @mark.fit_linear_regression       
    def test_sgd_fit_linear_regression_monitor_train_score(self, get_ames_data):        
        # Run model
        X, y = get_ames_data
    ...
    @mark.fit
    @mark.fit_linear_regression
    def test_sgd_fit_linear_regression_monitor_val_cost(self, get_ames_data):        
        # Run model
        X, y = get_ames_data
    ...
    @mark.fit
    @mark.fit_linear_regression
    def test_sgd_fit_linear_regression_monitor_val_score(self, get_ames_data):        
        # Run model
        X, y = get_ames_data
    ...
    def test_sgd_predict_linear_regression(self, get_ames_data):
        X, y = get_ames_data
        lr = LinearRegression(epochs=5)
        lr.fit(X, y)
        y_pred = lr.predict(X)
    ...
    def test_sgd_score_linear_regression(self, get_ames_data):
        X, y = get_ames_data
        lr = LinearRegression(epochs=5)
        lr.fit(X, y)
        score = lr.score(X, y)
    ...
    @mark.sgd 
    def test_sgd_linear_regression_sgd_batch_size_1(self, get_ames_data):
        X, y = get_ames_data
        lr = SGDRegression(epochs=5)
        lr.fit(X, y)
        total_epochs = lr.history.total_epochs
        total_batches = lr.history.total_batches
