...
class LassoRegressionTests:
    ...
    def test_lasso_regression_training_solution(self, train_lasso_regression,
                                                 analytical_solution_training_data):
        train_solution = analytical_solution_training_data
    ...
    @mark.lasso_regression
    def test_lasso_regression_test_scores(self, train_lasso_regression, 
                                           regression_metric):        
...
class RidgeRegressionTests:
    ...
    def test_ridge_regression_training_solution(self, train_ridge_regression,
                                                 analytical_solution_training_data):
        train_solution = analytical_solution_training_data
    ...
    @mark.ridge_regression
    def test_ridge_regression_test_scores(self, train_ridge_regression, 
                                           regression_metric):        
...
class ElasticNetRegressionTests:
    ...
    def test_elasticnet_regression_training_solution(self, train_elasticnet_regression,
                                                 analytical_solution_training_data):
        train_solution = analytical_solution_training_data
    ...
    @mark.elasticnet_regression
    def test_elasticnet_regression_test_scores(self, train_elasticnet_regression, 
                                           regression_metric):        
