...
class DataVisualator(BaseVisualator):
    ...
    def fit(self, x, y=None, z=None, data=None, labels=None **kwargs):
        """ Fits the visualator to the data.
        ...
        dataframe : Array-like, dict, or pd.DataFrame, 
            This argument needs to be passed when the x and y parameters
            are column names.             

        kwargs: dict
            Additional optionaly keyword arguments used for presenting 
